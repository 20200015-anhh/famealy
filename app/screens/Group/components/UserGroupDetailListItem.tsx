...
export interface UserGroupDetailListItemProps {
  item: Task
  index: number
}

export const UserGroupDetailListItem = observer(function UserGroupDetailListItem(
  props: UserGroupDetailListItemProps,
) {
