...
export const UserGroupListItem = observer(function UserGroupListItem(
  props: UserGroupListItemProps,
) {
  ...
  const render = () => {
    return (
      <View row style={$itemStyle} marginT-vs12 centerV>
        <View flex centerV>
          <TouchableOpacity onPress={() => navigation.navigate("UserGroupDetailList")}>
            <View row centerV>
              {renderImage(index)}
